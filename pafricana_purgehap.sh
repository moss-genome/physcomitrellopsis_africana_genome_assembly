...
/isg/shared/apps/purge_haplotigs/1.0/bin/purge_haplotigs purge -g physcomitrellopsis_africana_polished_3kb_rmvcontam_assembly.fasta -c coverage_stats.csv -b /labs/Wegrzyn/Moss/Physcomitrellopsis_africana/Physcomitrellopsis_africana_Genome/RawData_Nanopore_5074/5074_test_LSK109_30JAN19/physcomitrellopsis_africana_polished_3kb_rmvcomtam_genome.reads.sorted.bam -t 25
